...
NOTE: This correction factor is not currently applied.
...
Equation \ref{eq_coef_normal_force_body_lift} is divided by $\alpha$ to be added to $C_{N \alpha}$ calculated used in Equation \ref{rocket_center_of_pressure}.
