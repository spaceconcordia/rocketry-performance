...
A team from the \emph{Space Concordia} association at \emph{Concordia
University} is entering a submission into the \emph{International Rocket
Engineering Competition} (IREC) run by the \emph{Experimental Sounding
Rocket Association} (ESRA). To complement the team's mechanical design
process, an Engineering Simulation is required to validate the flight
performance criteria set by the competition. Matlab/Simulink was used as
an environment to model the flight dynamics and output the results.
Thorough unit and integration testing was performed, in addition to
comparison with experimental data to validate the model. Significant
areas beyond the scope of the project are explored, such as a thorough
stability analysis, preliminary considerations of a 6DOF simulator based
on quaternion rotations, stochastic parameter variation to determine
...
\subsubsection{Transonic Considerations}\label{transonic-considerations}
...
\begin{figure}[htbp]
\centering
\includegraphics{images/plots/TUC_plot.png}
\caption{Comparison of ISA Model with TUC Weather Balloon Data
...
The rocket flown at last years competition was also modeled. As shown
below, a high degree of accuracy with the avionics data is further
confirmed.
...
\subsubsection{Execution Output}\label{execution-output}

\begin{verbatim}
Matlab Apogee: 3.012697e+03 m, 9.881645e+03 ft 
Matlab Time to apogee: 2.445000e+01 s 
Maximum Matlab Altitude: 3.012697e+03 m, 9.881645e+03 ft 
Matlab Velocity leaving launch guide:              3.365308e+01 m/s 

Save plots (takes additional time)? [y/N] :y
Plotting output ... OpenRocket time to apogee :                 2.394000e+01 s 
Maximum OpenRocket altitude:                2.903400e+03 m, 9.523152e+03 ft 
Maximum OpenRocket Vertical Velocity:       2.738000e+02 m/s, 8.980640e+02 ft/s 
Maximum OpenRocket Mach Number:             8.500000e-01 m/s 
Maximum OpenRocket acceleration:  1.122000e+02 m/s^2, 3.420732e+01 ft/s^2, 1.143731e+01 g 
Maximum OpenRocket drag force:              1.138300e+03 N 
OpenRocket Velocity at launch guide:        1.016159e+01 m/s 
Maximum RASAero altitude:      3.301119e+03 m, 1.082767e+04 ft 
Maximum RASAero Mach Number:   8.518901e-01 m/s 
Maximum RASAero acceleration:  1.141303e+02 m/s^2, 3.743475e+02 ft/s^2, 1.162570e+01 g 
Velocity leaving launch guide: 3.353924e+01 m/s 
Maximum RockSim altitude:      3.677482e+04 m, 1.120842e+04 ft 
Maximum RockSim Velocity:      9.471690e+02 m/s, 2.887710e+02 ft/s 
Maximum RockSim acceleration:  3.698590e+02 m/s^2, 1.127619e+02 ft/s^2 1.148630e+01 g 
Maximum RockSim drag force:    1.737372e+02 m/s 
Velocity leaving launch guide: 1.019238e+01 m/s 
\end{verbatim}
...
requirement: \textgreater{} 2f - The vehicle does not experience
resonant pitching/yawing motion in flight
...
\begin{figure}[htbp]
\centering
\includegraphics{images/plots/plot_stability_homogeneous_response_damping_ratio.png}
...
The natural frequency of the rocket to pitch/yaw is {\textbf{???}}. This
does not come into resonance with the oscillatory response of the rocket
to disturbance.
...
{[}6{]} NASA, ``General thrust equation.'' Online.
