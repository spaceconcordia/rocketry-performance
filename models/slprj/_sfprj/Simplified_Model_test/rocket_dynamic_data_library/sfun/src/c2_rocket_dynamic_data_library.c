  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  c2_weight = c2_wet_motor_weight - c2_wfc * c2_thrust_curve;
  CV_EML_FOR(0, 1, 0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4269871221U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4094571726U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2346247157U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2406182496U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("WtFxaoCsJz4oNYeMIeSBNF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1256);
        _SFD_CV_INIT_EML_FOR(0,1,0,1124,1146,1210);
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2294756714U));
  ssSetChecksum1(S,(3036988803U));
  ssSetChecksum2(S,(3902626320U));
  ssSetChecksum3(S,(3342582497U));
