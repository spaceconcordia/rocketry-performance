...
static const char * c2_debug_family_names[8] = { "data_length", "i", "nargin",
  "nargout", "thrust_curve", "wet_motor_weight", "wfc", "weight_curve" };
...
static real_T c2_emlrt_marshallIn(SFc2_rocket_dynamic_data_libraryInstanceStruct
  *chartInstance, const mxArray *c2_weight_curve, const char_T *c2_identifier);
  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  real_T *c2_weight_curve;
  c2_weight_curve = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellmatrix(2, 1), false);
  c2_hoistedGlobal = *c2_weight_curve;
   ...
   c2_st)
{
  ...
  *c2_weight_curve = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 0)), "weight_curve");
  chartInstance->c2_is_active_c2_rocket_dynamic_data_library =
  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  c2_b_weight_curve = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_weight_curve, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_weight_curve = c2_wet_motor_weight - c2_wfc * c2_thrust_curve;
  CV_EML_FOR(0, 1, 0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -32);
  _SFD_SYMBOL_SCOPE_POP();
  *c2_b_weight_curve = c2_weight_curve;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_rocket_dynamic_data_libraryMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c2_b_weight_curve, 1U);
  ...
  *chartInstance, const mxArray *c2_weight_curve, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_weight_curve),
    &c2_thisId);
  sf_mex_destroy(&c2_weight_curve);
  return c2_y;
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  chartInstance = (SFc2_rocket_dynamic_data_libraryInstanceStruct *)
    chartInstanceVoid;
  c2_weight_curve = sf_mex_dup(c2_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3918571006U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4015349429U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(342266774U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2932162885U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("oUZiPUMOl3SOyk6QZv6q0");
...
static const mxArray *sf_get_sim_state_info_c2_rocket_dynamic_data_library(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"weight_curve\",},{M[8],M[0],T\"is_active_c2_rocket_dynamic_data_library\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1312);
        _SFD_CV_INIT_EML_FOR(0,1,0,1219,1241,1311);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c2_weight_curve);
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1037131580U));
  ssSetChecksum1(S,(2616985688U));
  ssSetChecksum2(S,(1208422339U));
  ssSetChecksum3(S,(4249323728U));
