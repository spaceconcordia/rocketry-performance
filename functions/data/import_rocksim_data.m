...
filename = 'C:\Users\scorpii\Documents\Space\Rocketry\Performance\rocketry-performance\data\aurelius_rocksim_simulation.csv';
delimiter = ',';
startRow = 2;
...
fprintf( 'Maximum RockSim acceleration:  %d m/s^2, %d ft/s^2 \r',...
