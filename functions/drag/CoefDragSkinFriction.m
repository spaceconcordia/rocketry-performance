...
coef_skin_friction_drag = coef_skin_drag_corrected * (  ( 1 + 1/ (2*fineness_ratio) )*area_wetted_body + (1+2*thickness_fins_base/fin_chord_length)*area_wetted_fins  ) / reference_area;
end
