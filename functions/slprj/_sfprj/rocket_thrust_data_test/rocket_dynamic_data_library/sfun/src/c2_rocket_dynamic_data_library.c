...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2572615975U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1065223230U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1774038535U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(994723870U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("tqz05hSGW6n6uuyYxFUX6D");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1150);
        _SFD_CV_INIT_EML_FOR(0,1,0,1016,1038,1103);
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(371184125U));
  ssSetChecksum1(S,(3979500736U));
  ssSetChecksum2(S,(2839146640U));
  ssSetChecksum3(S,(1726102919U));
