  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  *c2_b_thrust = c2_thrust;
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_weight, 5U);
  _SFD_DATA_RANGE_CHECK(*c2_b_thrust, 6U);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1943574524U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(630137489U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1234863631U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2974144197U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("gQrLoyZcjJFC8nTk3k2D1D");
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3114037724U));
  ssSetChecksum1(S,(3634796094U));
  ssSetChecksum2(S,(3554982201U));
  ssSetChecksum3(S,(921328132U));
