...
static const char * c2_debug_family_names[12] = { "data_length", "weight_buffer",
  "nargin", "nargout", "thrust_curve", "burntime", "wet_motor_weight",
  "dry_motor_weight", "wfc", "mass", "weight", "thrust" };
  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  real_T *c2_b_burntime;
  real_T *c2_b_mass;
  real_T *c2_b_wet_motor_weight;
  real_T *c2_b_dry_motor_weight;
  real_T *c2_b_wfc;
  real_T *c2_b_weight;
  real_T *c2_b_thrust;
  c2_b_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c2_b_weight = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_b_wfc = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c2_b_dry_motor_weight = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c2_b_burntime = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_burntime, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_thrust_curve;
  c2_b_hoistedGlobal = *c2_b_burntime;
  c2_c_hoistedGlobal = *c2_b_wet_motor_weight;
  c2_d_hoistedGlobal = *c2_b_dry_motor_weight;
  c2_e_hoistedGlobal = *c2_b_wfc;
  c2_thrust_curve = c2_hoistedGlobal;
  c2_burntime = c2_b_hoistedGlobal;
  c2_wet_motor_weight = c2_c_hoistedGlobal;
  c2_dry_motor_weight = c2_d_hoistedGlobal;
  c2_wfc = c2_e_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_weight_buffer, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_burntime, 5U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_wet_motor_weight, 6U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_dry_motor_weight, 7U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_wfc, 8U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_mass, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_weight, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_thrust, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_weight_buffer = c2_wet_motor_weight - c2_wfc * c2_burntime;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 23);
  if (CV_EML_IF(0, 1, 0, c2_weight_buffer <= c2_dry_motor_weight)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
    c2_weight = c2_dry_motor_weight;
    sf_mex_printf("%s =\\n", "weight");
    c2_u = c2_weight;
    c2_y = NULL;
    ...
    c2_weight = c2_wet_motor_weight - c2_wfc * c2_burntime;
  }
  ...
  *c2_b_thrust = c2_thrust;
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_mass, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_wet_motor_weight, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_b_dry_motor_weight, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_b_wfc, 5U);
  _SFD_DATA_RANGE_CHECK(*c2_b_weight, 6U);
  _SFD_DATA_RANGE_CHECK(*c2_b_thrust, 7U);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1932912073U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4223582483U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(590406248U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(17500799U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("MZWk6673IKN3BcAvRZkNkG");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(4,1,1,0,"dry_motor_weight");
          _SFD_SET_DATA_PROPS(5,1,1,0,"wfc");
          _SFD_SET_DATA_PROPS(6,2,0,1,"weight");
          _SFD_SET_DATA_PROPS(7,2,0,1,"thrust");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1174);
        _SFD_CV_INIT_EML_IF(0,1,0,927,963,994,1049);
...

        {
          ...
          c2_thrust = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c2_weight = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c2_wfc = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          c2_dry_motor_weight = (real_T *)ssGetInputPortSignal(chartInstance->S,
            3);
          c2_wet_motor_weight = (real_T *)ssGetInputPortSignal(chartInstance->S,
            2);
          c2_mass = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_burntime = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, c2_dry_motor_weight);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_wfc);
          _SFD_SET_DATA_VALUE_PTR(6U, c2_weight);
          _SFD_SET_DATA_VALUE_PTR(7U, c2_thrust);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1333834903U));
  ssSetChecksum1(S,(2308530959U));
  ssSetChecksum2(S,(1624052932U));
  ssSetChecksum3(S,(3408312492U));
