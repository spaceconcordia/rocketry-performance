  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  for (c2_i11 = 0; c2_i11 < 121; c2_i11++) {
    c2_weight[c2_i11] = c2_wet_motor_weight - c2_wfc * c2_burntime[c2_i11];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 27);
  for (c2_i12 = 0; c2_i12 < 121; c2_i12++) {
    c2_thrust[c2_i12] = c2_thrust_curve[c2_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 28);
  for (c2_i13 = 0; c2_i13 < 121; c2_i13++) {
    c2_a[c2_i13] = c2_weight[c2_i13];
  }

  for (c2_i14 = 0; c2_i14 < 121; c2_i14++) {
    c2_mass[c2_i14] = c2_a[c2_i14] * 9.81;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -28);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i15 = 0; c2_i15 < 121; c2_i15++) {
    (*c2_b_mass)[c2_i15] = c2_mass[c2_i15];
  }

  for (c2_i16 = 0; c2_i16 < 121; c2_i16++) {
    (*c2_b_weight)[c2_i16] = c2_weight[c2_i16];
  }

  for (c2_i17 = 0; c2_i17 < 121; c2_i17++) {
    (*c2_b_thrust)[c2_i17] = c2_thrust[c2_i17];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i21 = 0; c2_i21 < 121; c2_i21++) {
    c2_b_inData[c2_i21] = (*(real_T (*)[121])c2_inData)[c2_i21];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i24 = 0; c2_i24 < 121; c2_i24++) {
    (*(real_T (*)[121])c2_outData)[c2_i24] = c2_y[c2_i24];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2086719105U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1095189810U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3654282408U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1441684762U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("UPv1MKu5WmcRMlG7DCy9J");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1025);
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(793085383U));
  ssSetChecksum1(S,(3153677525U));
  ssSetChecksum2(S,(1092695293U));
  ssSetChecksum3(S,(2648310474U));
