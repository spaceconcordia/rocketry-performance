  ...
  (SFc2_rocket_dynamic_data_libraryInstanceStruct *chartInstance)
{
  ...
  for (c2_i7 = 0; c2_i7 < 121; c2_i7++) {
    c2_thrust_curve[c2_i7] = (*c2_b_thrust_curve)[c2_i7];
  }
  ...
  for (c2_i9 = 0; c2_i9 < 121; c2_i9++) {
    c2_b[c2_i9] = c2_thrust_curve[c2_i9];
  }
  ...
  for (c2_i11 = 0; c2_i11 < 121; c2_i11++) {
    c2_weight[c2_i11] = c2_wet_motor_weight - c2_b[c2_i11];
  }
  ...
  while (c2_b_i < 121) {
    ...
    c2_weight[_SFD_EML_ARRAY_BOUNDS_CHECK("weight", (int32_T)_SFD_INTEGER_CHECK(
      "i", c2_i), 1, 121, 1, 0) - 1] = c2_wet_motor_weight - c2_wfc * c2_i *
      0.01;
    sf_mex_printf("%s =\\n", "weight");
    for (c2_i12 = 0; c2_i12 < 121; c2_i12++) {
      c2_u[c2_i12] = c2_weight[c2_i12];
    }
  ...
  for (c2_i13 = 0; c2_i13 < 121; c2_i13++) {
    c2_thrust[c2_i13] = c2_thrust_curve[c2_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 27);
  for (c2_i14 = 0; c2_i14 < 121; c2_i14++) {
    c2_b[c2_i14] = c2_weight[c2_i14];
  }

  for (c2_i15 = 0; c2_i15 < 121; c2_i15++) {
    c2_mass[c2_i15] = c2_b[c2_i15] * 9.81;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -27);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i16 = 0; c2_i16 < 121; c2_i16++) {
    (*c2_b_mass)[c2_i16] = c2_mass[c2_i16];
  }

  for (c2_i17 = 0; c2_i17 < 121; c2_i17++) {
    (*c2_b_weight)[c2_i17] = c2_weight[c2_i17];
  }

  for (c2_i18 = 0; c2_i18 < 121; c2_i18++) {
    (*c2_b_thrust)[c2_i18] = c2_thrust[c2_i18];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i22 = 0; c2_i22 < 121; c2_i22++) {
    c2_b_inData[c2_i22] = (*(real_T (*)[121])c2_inData)[c2_i22];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i25 = 0; c2_i25 < 121; c2_i25++) {
    (*(real_T (*)[121])c2_outData)[c2_i25] = c2_y[c2_i25];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3511906417U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3013463449U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2543368173U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(726636309U);
}
...
mxArray *sf_c2_rocket_dynamic_data_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VnZQPAEbRfPTjaAyXyZLZB");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,999);
        _SFD_CV_INIT_EML_FOR(0,1,0,879,901,952);
...
static void mdlSetWorkWidths_c2_rocket_dynamic_data_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4119767784U));
  ssSetChecksum1(S,(3473990682U));
  ssSetChecksum2(S,(1942594395U));
  ssSetChecksum3(S,(882127604U));
