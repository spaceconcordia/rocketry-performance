...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_rocket_thrust_data_test_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_rocket_dynamic_data_library_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_rocket_thrust_data_test_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_rocket_thrust_data_test_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "rocket_thrust_data_test") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_rocket_thrust_data_test_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_rocket_thrust_data_test_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "rocket_thrust_data_test") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_rocket_thrust_data_test_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_rocket_thrust_data_test_updateBuildInfo_args_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "rocket_thrust_data_test") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_rocket_thrust_data_test_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_rocket_thrust_data_test_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int
  ...
  if (strcmp(machineName, "rocket_thrust_data_test") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_rocket_thrust_data_test_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_rocket_thrust_data_test_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"rocket_thrust_data_test")) {
    return(sf_rocket_thrust_data_test_method_dispatcher(simstructPtr,
...
extern void rocket_thrust_data_test_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    rocket_thrust_data_test_terminator();
...
extern void rocket_thrust_data_test_initializer(void);
extern void rocket_dynamic_data_library_initializer(void);
extern void rocket_thrust_data_test_register_exported_symbols(SimStruct* S);
extern void rocket_dynamic_data_library_register_exported_symbols(SimStruct* S);
extern void rocket_thrust_data_test_debug_initialize(struct
...
{
  rocket_thrust_data_test_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      rocket_thrust_data_test_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    rocket_thrust_data_test_initializer();
    if (!simModeIsRTWGen) {
