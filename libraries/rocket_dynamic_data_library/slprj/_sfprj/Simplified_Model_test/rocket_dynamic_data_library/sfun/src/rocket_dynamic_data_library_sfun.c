  ...
  method, void *data)
{
  if (chartFileNumber==1) {
    c1_rocket_dynamic_data_library_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"rocket_dynamic_data_library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(343513455U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1891616629U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(118945197U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3656675257U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_rocket_dynamic_data_library_get_check_sum
                (mxArray *plhs[]);
              sf_c1_rocket_dynamic_data_library_get_check_sum(plhs);
              break;
            }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "ODhAHFL5COcIoymtto5TfB") == 0) {
          extern mxArray
            *sf_c1_rocket_dynamic_data_library_get_autoinheritance_info(void);
          plhs[0] = sf_c1_rocket_dynamic_data_library_get_autoinheritance_info();
          break;
        }
     ...
     case 1:
      {
        extern const mxArray
          *sf_c1_rocket_dynamic_data_library_get_eml_resolved_functions_info
          (void);
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "BZ7GHe3aHaVk8Ref2cQG6C") == 0) {
          extern mxArray
            *sf_c1_rocket_dynamic_data_library_third_party_uses_info(void);
          plhs[0] = sf_c1_rocket_dynamic_data_library_third_party_uses_info();
          break;
        }
      }
     ...
     case 1:
      {
        if (strcmp(tpChksum, "BZ7GHe3aHaVk8Ref2cQG6C") == 0) {
          extern mxArray
            *sf_c1_rocket_dynamic_data_library_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_rocket_dynamic_data_library_updateBuildInfo_args_info();
          break;
        }
      }
...
mxArray* load_rocket_dynamic_data_library_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "rocket_dynamic_data_library", "Simplified_Model_test");
